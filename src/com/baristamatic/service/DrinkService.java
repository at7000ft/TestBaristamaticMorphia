...
public class DrinkService {
   private DrinkDao ddao = new DrinkDao();
   private InventoryEntryDao idao = new InventoryEntryDao();
   ...
   public boolean createDrink(Integer number) {
      Drink drink = ddao.getDrink(number);
